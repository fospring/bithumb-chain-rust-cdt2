(module
  ...
  (func $alloc::raw_vec::RawVec<T_A>::allocate_in::h0630cf576e49aff5 (type 9) (param i32 i32 i32)
    ...
    unreachable
    unreachable)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_u64>::encode::h28c9c9b966e7dd52 (type 10) (param i64 i32)
  ...
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_u64>::to_bxa_string::h855ed92330fe2d18 (type 7) (param i32 i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 64
    i32.sub
  ...
  (func $core::panicking::panic_fmt::h8a97af3c4a58de81 (type 7) (param i32 i32)
    ...
    unreachable)
  (func $core::fmt::num::imp::fmt_u64::h410eebb512c98a23 (type 11) (param i64 i32) (result i32)
    ...
    global.set 0
    local.get 3)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_bxa_std::types::H160>::to_bxa_string::h137fb988d8d2a422 (type 7) (param i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func $core::fmt::builders::DebugTuple::finish::h4801ea02cabff854 (type 3) (param i32) (result i32)
    ...
    i32.const 0
    i32.ne)
  (func $bxa_abi::bxa::stream::Stream::read_into::h026c240d37ff0a3f (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    i32.const 4
    local.set 3
    block  ;; label = @1
  ...
  (func $core::slice::slice_index_order_fail::h3d34e0ef769a011f (type 7) (param i32 i32)
    ...
    call $core::panicking::panic_fmt::h8a97af3c4a58de81
    unreachable)
  (func $bxa_abi::bxa::stream::Stream::read_u64::hb131d58a47166503 (type 7) (param i32 i32)
    (local i32 i32 i64)
    global.get 0
    i32.const 16
    i32.sub
    ...
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          ...
          i32.add
          i32.const 1
          call $bxa_abi::bxa::stream::Stream::read_into::h026c240d37ff0a3f
          i32.const 255
          i32.and
          local.tee 3
          i32.const 7
  ...
  (func $<&mut_W_as_core::fmt::Write>::write_fmt::h13b3254cf0bee8a7 (type 1) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 1)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::decode::h3a4c1ef6ab01ba7b (type 7) (param i32 i32)
    ...
    local.get 2
    local.get 1
    call $bxa_abi::bxa::stream::Stream::read_u64::hb131d58a47166503
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::encode::hbb638407ba0a269c (type 7) (param i32 i32)
    ...
    i64.extend_i32_u
    local.get 1
    call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_u64>::encode::h28c9c9b966e7dd52
    local.get 1
    local.get 0
    i32.load
    local.tee 3
  ...
  (func $wee_alloc::alloc_first_fit::heb08c623bbd02e66 (type 6) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 8
    i32.add)
  (func $core::ptr::real_drop_in_place::hb362d9cbd0511fba.163 (type 5) (param i32))
  ...
  (func $<T_as_core::any::Any>::type_id::hfbb4b8d9c7d9a397 (type 12) (param i32) (result i64)
    i64.const 7449047898292658853)
  (func $core::fmt::Formatter::pad_integral::write_prefix::ha9a4dda6c99c9c72 (type 13) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
  ...
  (func $bxa_api::db::get::h536c31f322ca0737 (type 7) (param i32 i32)
    ...
    call $core::slice::slice_index_order_fail::h3d34e0ef769a011f
    unreachable)
  (func $bxa_api::db::put::hb5ab1c2e7688b0db (type 14) (param i32 i64)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    unreachable)
  (func $call (type 8)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 i64 i32)
    global.get 0
    i32.const 240
    i32.sub
    local.tee 0
    ...
    i32.const 72
    i32.add
    call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::decode::h3a4c1ef6ab01ba7b
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
                                ...
                                block  ;; label = @15
                                  block  ;; label = @16
                                    ...
                                    block  ;; label = @17
                                      ...
                                      i32.const 136
                                      i32.add
                                      call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_bxa_std::types::H160>::to_bxa_string::h137fb988d8d2a422
                                      local.get 3
                                      local.get 6
                                      i32.load
                                      i32.store
                                      ...
                                      i32.const 160
                                      i32.add
                                      call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_u64>::to_bxa_string::h855ed92330fe2d18
                                      local.get 3
                                      local.get 6
                                      i32.load
                                      i32.store
