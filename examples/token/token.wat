(module
  ...
  (func $alloc::raw_vec::RawVec<T_A>::allocate_in::h0630cf576e49aff5 (type 9) (param i32 i32 i32)
    ...
    unreachable
    unreachable)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::ToBXAString_for_u64>::to_bxa_string::h7a3fc086268bfead (type 7) (param i32 i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 64
    i32.sub
  ...
  (func $core::fmt::num::imp::fmt_u64::h410eebb512c98a23 (type 10) (param i64 i32) (result i32)
    ...
    global.set 0
    local.get 3)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::ToBXAString_for_bxa_std::types::H160>::to_bxa_string::hba0ff6c49c14a146 (type 7) (param i32 i32)
  ...
  (func $<&mut_W_as_core::fmt::Write>::write_fmt::h13b3254cf0bee8a7 (type 1) (param i32 i32) (result i32)
    ...
    global.set 0
    local.get 1)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::decode::hb4ceb373c3cb4e3c (type 7) (param i32 i32)
                      ...
                      block  ;; label = @10
                        block  ;; label = @11
                          block  ;; label = @12
                            block  ;; label = @13
                              local.get 3
                              br_table 0 (;@13;) 5 (;@8;) 2 (;@11;) 3 (;@10;) 1 (;@12;) 6 (;@7;) 8 (;@5;) 4 (;@9;) 0 (;@13;)
                            end
                            local.get 2
                            i32.const 0
                            i32.store8 offset=15
  ...
  (func $core::slice::slice_index_len_fail::hb81ac75c4a989ce8 (type 7) (param i32 i32)
    ...
    call $core::panicking::panic_fmt::h8a97af3c4a58de81
    unreachable)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::encode::h08ec04d4f7e9d330 (type 7) (param i32 i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    ...
    i32.add
    global.set 0)
  (func $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::push_type::h73e82068f34614bf (type 7) (param i32 i32)
    local.get 1
    i32.const 7
  ...
  (func $wee_alloc::alloc_first_fit::heb08c623bbd02e66 (type 6) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.const 8
    i32.add)
  (func $core::ptr::real_drop_in_place::hb362d9cbd0511fba.141 (type 5) (param i32))
  ...
  (func $call (type 8)
    ...
    i32.const 72
    i32.add
    call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::decode::hb4ceb373c3cb4e3c
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
                  ...
                  block  ;; label = @8
                    block  ;; label = @9
                      ...
                      block  ;; label = @10
                                ...
                                block  ;; label = @15
                                  block  ;; label = @16
                                    ...
                                    block  ;; label = @17
                                      ...
                                      i32.const 168
                                      i32.add
                                      call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::encode::h08ec04d4f7e9d330
                                      local.get 0
                                      i32.const 184
                                      i32.add
                                      local.get 0
                                      i32.const 136
                                      i32.add
                                      call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::ToBXAString_for_bxa_std::types::H160>::to_bxa_string::hba0ff6c49c14a146
                                      local.get 3
                                      local.get 6
                                      i32.load
                                      i32.store
                                      ...
                                      i32.const 160
                                      i32.add
                                      call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::ToBXAString_for_u64>::to_bxa_string::h7a3fc086268bfead
                                      local.get 3
                                      local.get 6
                                      i32.load
                                      i32.store
                        ...
                        i32.const 136
                        i32.add
                        call $bxa_abi::bxa::common::<impl_bxa_abi::bxa::AbiType_for_alloc::string::String>::push_type::h73e82068f34614bf
                        local.get 0
                        i32.const 216
                        i32.add
                        i32.const 8
